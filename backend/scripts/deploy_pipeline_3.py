"""
Script pour créer un deployment du Pipeline 3 sur CraftAI
"""
...
def main():
    print("="*80)
    print("Déploiement du Pipeline 3 - generate_legal_debate")
    print("="*80)

    sdk = CraftAiSdk()

    deployment_name = "generate-legal-debate-deploy"
    ...
    try:
        ...
        deployment = sdk.create_deployment(
            ...
            description="Deployment du pipeline de génération de débat juridique"
        )
        ...
        print(f"\nℹ️ Vérifiez:")
        print(f"   - Que le pipeline 'generate-legal-debate' existe")
