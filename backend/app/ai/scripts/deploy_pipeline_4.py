"""
Script pour créer un deployment du Pipeline citation sur CraftAI
"""
...
def main():
    print("=" * 80)
    print("Déploiement du Pipeline - citation")
    print("=" * 80)
    ...
    deployment_name = "citation-deploy"
    ...
    try:
        ...
        deployment = sdk.create_deployment(
            ...
            description="Deployment du pipeline de citations juridiques avec explications concises"
        )
        ...
        print(f"   PIPELINE_4_ENDPOINT_URL={deployment.get('endpoint_url', 'ENDPOINT_URL')}")
        print(f"   PIPELINE_4_ENDPOINT_TOKEN={deployment.get('endpoint_token', 'ENDPOINT_TOKEN')}")
        ...
        print(f"\nℹ️  Vérifiez:")
        print(f"   - Que le pipeline 'citation' existe")
